      ...
      <div className="mt-4 space-y-3 text-xs">
        <div className="card p-3">
          ...
          <div className="space-y-1">
            <div className="flex justify-between px-2">
              ...
              <span className="font-mono">{selectedMatch.attack_points}</span>
            </div>
            <div className="flex justify-between px-2 text-rose-500">
              <span>Errores</span>
              <span className="font-mono">{selectedMatch.attack_errors}</span>
            </div>
            <div className="flex justify-between px-2">
              <span>Intentos</span>
              <span className="font-mono">{selectedMatch.attack_attempts}</span>
            </div>
            <div className="flex justify-between px-2">
              <span>Puntos por set</span>
              <span className="font-mono text-emerald-500">
                {selectedMatch.attack_points_per_set.toFixed(2)}
              </span>
            </div>
            <div className="border-t border-slate-300 pt-1 dark:border-slate-700">
              <div className="flex justify-between px-2 font-semibold">
                ...
                <span className="text-sky-500">
                  {formatPerformance(selectedMatch.attack_efficiency)}
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="card p-3">
          ...
          <div className="space-y-1">
            <div className="flex justify-between px-2">
              <span>Aces</span>
              <span className="font-mono">{selectedMatch.serve_aces}</span>
            </div>
            <div className="flex justify-between px-2 text-rose-500">
              <span>Errores</span>
              <span className="font-mono">{selectedMatch.serve_errors}</span>
            </div>
            <div className="flex justify-between px-2">
              <span>Intentos</span>
              <span className="font-mono">{selectedMatch.serve_attempts}</span>
            </div>
            <div className="flex justify-between px-2">
              <span>Porcentaje de aciertos</span>
              <span className="font-mono text-emerald-500">
                {formatPerformance(selectedMatch.serve_in_percentage)}
              </span>
            </div>
            <div className="border-t border-slate-300 pt-1 dark:border-slate-700">
              <div className="flex justify-between px-2 font-semibold">
                ...
                <span className="text-sky-500">
                  {formatPerformance(selectedMatch.serve_efficiency)}
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="card p-3">
          ...
          <div className="space-y-1">
            <div className="flex justify-between px-2">
              ...
              <span className="font-mono">{selectedMatch.reception_three}</span>
            </div>
            <div className="flex justify-between px-2">
              <span>Recepciones 2</span>
              <span className="font-mono">{selectedMatch.reception_two}</span>
            </div>
            <div className="flex justify-between px-2">
              <span>Recepciones 1</span>
              <span className="font-mono">{selectedMatch.reception_one}</span>
            </div>
            <div className="flex justify-between px-2 text-rose-500">
              <span>Recepciones 0</span>
              <span className="font-mono">{selectedMatch.reception_zero}</span>
            </div>
            <div className="flex justify-between px-2">
              <span>Intentos</span>
              <span className="font-mono">
                {selectedMatch.reception_attempts}
              </span>
            </div>
            <div className="border-t border-slate-300 pt-1 dark:border-slate-700">
              <div className="flex justify-between px-2 font-semibold">
                ...
                <span className="text-sky-500">
                  {formatPerformance(selectedMatch.reception_efficiency)}
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="card p-3">
          ...
          <div className="space-y-1">
            ...
            <div className="flex justify-between px-2">
              ...
              <span className="font-mono">{selectedMatch.block_kill}</span>
            </div>
            <div className="flex justify-between px-2">
              <span>Bloqueos 1</span>
              <span className="font-mono">{selectedMatch.block_touch}</span>
            </div>
            <div className="flex justify-between px-2 text-rose-500">
              <span>Bloqueos 0</span>
              <span className="font-mono">{selectedMatch.block_error}</span>
            </div>
            <div className="flex justify-between px-2">
              <span>Total de acciones de bloqueo</span>
              <span className="font-mono">{selectedMatch.block_total}</span>
            </div>
            <div className="border-t border-slate-300 pt-1 dark:border-slate-700">
              <div className="flex justify-between px-2 font-semibold">
                <span>
                  Eficiencia Defensa = (Exitosas - Fallidas) / (Exitosas +
                  Fallidas)
                </span>
                <span className="text-sky-500">
                  {formatPerformance(selectedMatch.defense_efficiency)}
                </span>
              </div>
              <div className="flex justify-between px-2 font-semibold">
                <span>
                  Eficiencia Bloqueo = ((Bloqueos 2 x 2) + Bloqueos 1) / (Total
                  x 2)
                </span>
                <span className="text-sky-500">
                  {formatPerformance(selectedMatch.block_efficiency)}
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="card p-3">
          ...
          <div className="space-y-1">
            <div className="flex justify-between px-2">
              ...
              <span className="font-mono">{selectedMatch.set_assists}</span>
            </div>
            <div className="flex justify-between px-2 text-rose-500">
              <span>Errores</span>
              <span className="font-mono">{selectedMatch.set_errors}</span>
            </div>
            <div className="flex justify-between px-2">
              <span>Intentos</span>
              <span className="font-mono">{selectedMatch.set_attempts}</span>
            </div>
            <div className="border-t border-slate-300 pt-1 dark:border-slate-700">
              <div className="flex justify-between px-2 font-semibold">
                <span>Eficiencia = (Asistencias - Errores) / Intentos</span>
                <span className="text-sky-500">
                  {formatPerformance(selectedMatch.setting_efficiency)}
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="card-accent">
          <p className="mb-3 font-semibold accent-text dark:accent-text">
            EFICIENCIA GLOBAL DEL PARTIDO
          </p>
          <div className="space-y-1 text-xs">
            <div className="flex justify-between px-2">
              <span>
                Suma de ataque, saque, recepción, armado, defensa y bloqueo
                dividida entre 4 (tope 100%)
              </span>
            </div>
            <div className="flex justify-between px-2 font-mono">
              <span>
                min(100, ({selectedMatch.attack_efficiency.toFixed(2)} +{" "}
                {selectedMatch.serve_efficiency.toFixed(2)} +{" "}
                {selectedMatch.reception_efficiency.toFixed(2)} +{" "}
                {selectedMatch.setting_efficiency.toFixed(2)} +{" "}
                {selectedMatch.defense_efficiency.toFixed(2)} +{" "}
                {selectedMatch.block_efficiency.toFixed(2)}) / 4)
              </span>
            </div>
            <div className="border-t-2 border-sky-300 pt-2 dark:border-sky-800">
              <div className="flex justify-between px-2 text-sm font-extrabold">
                ...
                <span className="text-sky-600 dark:text-sky-400">
                  {formatPerformance(selectedMatch.match_performance)}
                </span>
              </div>
            </div>
          </div>
    ...
    <article className="card xl:col-span-2">
      ...
      {matchRatingsLoading ? (
        ...
        <p className="mt-4 text-sm text-slate-600 dark:text-slate-300">
          Selecciona un partido para ver el top de ese partido.
        </p>
      )}
    </article>
  );
          ...
          {history.map((match) => (
            ...
            >
              <div className="flex items-start justify-between gap-3">
                ...
                <p className="shrink-0 text-base font-bold text-sky-500">
                  {formatPerformance(match.match_performance)}
                </p>
              </div>
            </button>
          ))}
            ...
            <tbody>
              {history.map((match) => (
                ...
                >
                  ...
                  <td className="px-3 py-3 font-semibold text-sky-500">
                    {formatPerformance(match.match_performance)}
                  </td>
                </tr>
              ))}
          ...
          <div className="mt-4 space-y-4 text-sm">
            ...
            <MetricBars
              ...
              metrics={[
                {
                  label: "Recepcion",
                  value: selectedMatch.reception_efficiency,
                },
