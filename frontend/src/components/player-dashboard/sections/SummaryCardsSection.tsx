...
export function SummaryCardsSection({ active, summaryCards }: SummaryCardsSectionProps) {
  return (
    <section className={active ? 'grid gap-4 md:grid-cols-2 xl:grid-cols-4' : 'hidden'}>
