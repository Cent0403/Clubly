...
export function MedalsPanel({ history }: MedalsPanelProps) {
  ...
  if (groups.length === 0) {
    return (
      <div className="rounded-2xl border border-slate-200 bg-slate-50 px-3 py-2 text-sm text-slate-600 dark:border-slate-800 dark:bg-slate-950/30 dark:text-slate-300">
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-slate-50 p-2 text-sm dark:border-slate-800 dark:bg-slate-950/30">
      ...
      <div className="grid gap-2">
        {groups.map((group) => (
          <div key={group.category} className="flex flex-wrap items-center gap-2 rounded-2xl border border-slate-200 bg-white px-2 py-2 text-[11px] text-slate-700 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300">
