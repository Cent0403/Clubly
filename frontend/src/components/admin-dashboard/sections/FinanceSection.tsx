    ...
    <section className={active ? 'space-y-6' : 'hidden'}>
      ...
      <section className="grid gap-6 xl:grid-cols-5">
        <article className="card xl:col-span-2">
          <h3 className="text-xl font-bold">Crear categoría</h3>
          <form className="mt-4 space-y-3" onSubmit={onCreateCategory}>
            ...
            <button className="btn-primary w-full" type="submit" disabled={loadingFinance}>
              {loadingFinance ? 'Guardando...' : 'Guardar categoría'}
            </button>
          </form>
        ...
        <article className="card xl:col-span-3">
          ...
          <form className="mt-4 grid gap-3 md:grid-cols-2" onSubmit={onCreateTransaction}>
            ...
            <button className="btn-primary md:col-span-2" type="submit" disabled={loadingFinance}>
              {loadingFinance ? 'Guardando...' : 'Guardar movimiento'}
            </button>
          </form>
      ...
      <section className="grid gap-6 xl:grid-cols-5">
        <article className="card xl:col-span-2">
          <h3 className="text-xl font-bold">Asignar deuda a jugador</h3>
          <form className="mt-4 space-y-3" onSubmit={onCreateDebt}>
            ...
            />
            <button className="btn-primary w-full" type="submit" disabled={loadingFinance}>
              {loadingFinance ? 'Guardando...' : 'Guardar deuda'}
            </button>
          </form>
        </article>
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-3 grid gap-2 md:grid-cols-4">
                    ...
                    />
                    <button
                      className="btn-muted md:col-span-2"
                      type="button"
